...
document.getElementById("show-tracker").addEventListener("click", () => {
  const pass = prompt("Enter password to view tracker:");
  if (pass === "3Noesis8") {
    const usage = localStorage.getItem("app_usage") || "1 user(s)";
    document.getElementById("tracker-info").innerText = `Total Users: ${usage}`;
    document.getElementById("tracker-info").style.display = "block";
  } else {
